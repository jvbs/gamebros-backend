            ...
            <div class="row">
                ...
                <div class="col-6 mt-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="sku" class="form-control" id="InputSKU" placeholder="">
                    </div>
                </div>
                <div class="col-12 mt-4">
                    <div class="form-group">
                        <label for="descricao">Descricao*</label>
                        <textarea class="form-control" name="description" id="InputDescricao" placeholder=""></textarea>
                    </div>
                </div>
                <div class="col-6 mt-4">
                    <div class="form-group">
                ...
                <div class="col-6 mt-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="price" class="form-control" id="InputPreco" placeholder="">
                    </div>
                </div>
                <div class="col-6 mt-4">
                    <div class="form-group">
                        <label for="desconto">Desconto*</label>
                        <input type="number" name="discount" class="form-control" id="InputDesconto" placeholder="">
                    </div>
                </div>
                ...
                <div class="col-6 mt-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="stock" class="form-control" id="InputEstoque" placeholder="">
                    </div>
                </div>
                <div class="col-6 mt-4">
